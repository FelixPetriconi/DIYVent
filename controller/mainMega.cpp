...
#include <modm/platform/i2c/i2c_master.hpp>
#include <modm/platform/uart/uart1.hpp>
#include <modm/platform/uart/uart2.hpp>
...
using MyI2cMaster = I2cMaster;

modm::Ssd1306<MyI2cMaster> *logDisplay = nullptr;
modm::sab2::Interface<Uart1, DIYV::MaxPayloadLength> sab;
...
void init()
{
    ...
    Uart1::initialize<Board::SystemClock, 38400>();

    enableInterrupts();    

    MyI2cMaster::connect<Board::D20::Sda, Board::D21::Scl>();
